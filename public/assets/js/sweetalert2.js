...
(function(global, factory) {
  ...
  var getFocusableElements = function getFocusableElements() {
    ...
    return uniqueArray(focusableElementsWithTabindex.concat(otherFocusableElements)).filter(
      function(el) {
        return isVisible(el);
      }
    );
  ...
  var sweetHTML = '\n <div aria-labelledby="'
    ...
    .concat(swalClasses.close, '">&times;</button>\n   </div>\n   <div class="')
  ...
  var lockBodyScroll = function lockBodyScroll() {
    ...
    container.ontouchstart = function(e) {
      preventTouchMove =
        e.target === container || (!isScrollable(container) && e.target.tagName !== 'INPUT'); // #1603
    };
  ...
  function setParameters(params) {
    ...
    var targetElement =
      typeof params.target === 'string' ? document.querySelector(params.target) : params.target;
  ...
  function _main(userParams) {
    ...
    return new Promise(function(resolve) {
      ...
      if (innerParams.input === 'select' || innerParams.input === 'radio') {
        ...
        ['text', 'email', 'number', 'tel', 'textarea'].indexOf(innerParams.input) !== -1 &&
